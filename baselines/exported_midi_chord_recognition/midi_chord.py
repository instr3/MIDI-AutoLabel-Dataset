...
class ChordRecognition:
    ...
    def __init__(self,entry,decode_chord_class:ChordClass,half_beat_switch=True,single_beat_switch=True):
        '''
        ...
        self.single_beat_switch=single_beat_switch
    ...
    def decode(self, use_transition=True):
        '''
